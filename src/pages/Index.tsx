  ...
  return (
    <article className="feed-reel group relative -mx-3 w-[calc(100%+1.5rem)] max-w-[calc(100%+1.5rem)] min-h-[calc(100svh-148px)] overflow-hidden bg-secondary shadow-[var(--shadow-editorial)] ring-1 ring-border/55 md:mx-0 md:w-full md:max-w-full md:min-h-[760px] md:rounded-[32px]">
      ...
      <div className="absolute bottom-0 left-0 right-16 p-4 pb-7 text-foreground sm:p-7">
        ...
        <a href={`/items/${item.slug}`} className="relative z-10 block min-w-0"><h2 className="break-words font-display text-3xl font-black leading-none sm:text-5xl">{item.name}</h2></a>
...
const Index = () => {
  ...
  return (
    <main className="min-h-screen w-full max-w-full overflow-x-hidden bg-background pb-28 text-foreground md:pb-8">
      ...
      <nav className="fixed inset-x-3 bottom-3 z-20 grid max-w-[calc(100vw-1.5rem)] grid-cols-5 items-center rounded-full glass-surface p-1.5 md:hidden">
