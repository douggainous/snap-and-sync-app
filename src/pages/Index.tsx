...
type WantToTryDish = MenuItem & { saved_at?: string | null; distance_miles?: number | null; location_group: string; plan_group: "Plan to visit" | "Nearby" | "Saved for later" };
...
const WantToTryPlanner = ({ dishes }: { dishes: WantToTryDish[] }) => {
